        ...
        <section class="Section">
            ...
            <form action="" method="POST" autocomplete="off" class="Main__Form">
                <div class="Main__Form-Group">
                    ...
                    <input type="text" value="<?=$data['Genre']->Genre_Name;?>" name="Genre_Name" id="Genre_Name" placeholder="Escribe aquí el nombre del género">
                    <span>
                ...
                <div class="Main__Form-Group">
                    ...
                    <input type="text" value="<?=$data['Genre']->Genre_Description;?>" name="Genre_Description" id="Genre_Description" placeholder="Escribe aquí una pequeña descripción del género">
                    <span>
