        ...
        <section class="Section">
            ...
            <form action="" method="POST" autocomplete="off" class="Main__Form">
                <div class="Main__Form-Group">
                    ...
                    <input type="text" value="<?= $data['Publisher']->Publisher_Name ?>" name="Publisher_Name" id="Publisher_Name" placeholder="Ingrese el nombre de la editorial">
                    <span>
                ...
                <div class="Main__Form-Row">
                    <div class="Main__Form-Group">
                        ...
                        <input type="text" value="<?= $data['Publisher']->Origin_Country ?>" name="Origin_Country" id="Origin_Country" placeholder="Ingrese el país de origen">
                        <span>
                    ...
                    <div class="Main__Form-Group">
                        ...
                        <input type="phone" value="<?= $data['Publisher']->Phone_Number ?>" name="Phone_Number" id="Phone_Number" placeholder="Escribe el número telefónico">
                        <span>
