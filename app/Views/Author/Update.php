            ...
            <form action="" method="POST" autocomplete="off" class="Main__Form">
                <div class="Main__Form-Row">
                    <div class="Main__Form-Group">
                        ...
                        <input type="text" value="<?= $data['Author']->First_Name ?>" name="First_Name" id="First_Name" placeholder="Ingrese el nombre del autor">
                        <span>
                    ...
                    <div class="Main__Form-Group">
                        ...
                        <input type="text" value="<?= $data['Author']->Last_Name ?>" name="Last_Name" id="Last_Name" placeholder="Ingrese el apellido del autor">
                        <span>
                ...
                <div class="Main__Form-Group">
                    ...
                    <input type="text" value="<?= $data['Author']->Origin_Country ?>" name="Origin_Country" id="Origin_Country" placeholder="¿Cuál es su país de origen?">
                    <span>
